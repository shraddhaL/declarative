...
//  deploy adapters: [tomcat9(credentialsId: 'c4046d3f-d8d7-4771-9691-9d929fa08e9d', path: '', url: 'http://3.134.92.78:8080/')], contextPath: 'rpps', war: '.war'
         ...
         stage('Deploy') {
             steps {
             deploy adapters: [tomcat9(credentialsId: 'c4046d3f-d8d7-4771-9691-9d929fa08e9d', path: '', url: 'http://3.133.84.113:8080/')], contextPath: 'rpps', war: '**/*.war'
             }
         }
         
          stage('Monitor') {
             steps {
                    sh '''url=\'http://3.133.84.113:8080/rpps\'
